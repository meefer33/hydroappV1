...
export type HeaderQueryVariables = StorefrontAPI.Exact<{
  ...
  headerMenuScroll: StorefrontAPI.Scalars['String']['input'];
  headerMenuCatalog: StorefrontAPI.Scalars['String']['input'];
